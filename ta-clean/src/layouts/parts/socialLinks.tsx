// ─── Shared social links used across Footer, Header, and any other component ──
// SoundCloud is the active music platform. Spotify is Coming Soon.
...
export const socialLinks: SocialLink[] = [
  ...
  {
    label: 'X (Twitter)',
    href: 'https://x.com/thealchemi21261',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/thealchemism',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/thealchemism',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
  ...
  {
    label: 'SoundCloud',
    href: 'https://soundcloud.com/stuart-parker-179445015',
    icon: (
      <svg viewBox="0 0 1200 560" className="w-5 h-5" fill="currentColor">
        <path d="M0 400c0 55.2 44.8 100 100 100s100-44.8 100-100V280c0-22.1-17.9-40-40-40s-40 17.9-40 40v18C107.6 325 90 307 70 307c-38.7 0-70 31.3-70 70V400zM200 400V300c0-22.1 17.9-40 40-40s40 17.9 40 40v100c0 55.2-44.8 100-100 100s-100-44.8-100-100h120zM320 400V240c0-22.1 17.9-40 40-40s40 17.9 40 40v160c0 55.2-44.8 100-100 100s-100-44.8-100-100h120zM440 400V180c0-22.1 17.9-40 40-40s40 17.9 40 40v220c0 55.2-44.8 100-100 100s-100-44.8-100-100h120zM560 500c44.8 0 80-44.8 80-100V120c0-22.1-17.9-40-40-40s-40 17.9-40 40v280c0 22.1-17.9 40-40 40s-40-17.9-40-40V120c0-22.1-17.9-40-40-40s-40 17.9-40 40V400c0 55.2 35.8 100 80 100h80zM700 500h400c55.2 0 100-44.8 100-100V260c0-55.2-44.8-100-100-100-15.2 0-29.6 3.4-42.4 9.4C1041.8 110.8 992 72 933 72c-81.6 0-147.7 66.4-147.7 148.2 0 5.2.3 10.2.9 15.2C762 242.5 736 275.7 736 315.4V400c0 55.2 35.8 100 80 100H700z"/>
      </svg>
    ),
  },
  {
    ...
    comingSoon: true,
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" style={{ opacity: 0.35 }}>
  ...
  {
    label: 'Discord',
    href: 'https://discord.com/channels/1353767297973616746/1503944975103037533',
    icon: (
      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
